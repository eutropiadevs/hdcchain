...
func New(dir string) *hdc.App {
	var (
		db       = tmdb.NewMemDB()
		logger   = log.NewNopLogger()
		encoding = hdc.MakeEncodingConfig()
	)

	a := hdc.New(logger, db, nil, true, map[int64]bool{}, dir, 0, encoding,
		simapp.EmptyAppOptions{}, hdc.GetWasmEnabledProposals(), hdc.EmptyWasmOpts)
